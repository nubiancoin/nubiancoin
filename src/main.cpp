...
int64 nChainStartTime = 1487412488;
...
const string strMessageMagic = "nubiancoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in nubiancoin
    bool fStrictPayToScriptHash = true; // Always active in nubiancoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "nubiancoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        //const char* pszTimestamp = "CBigNum vector nubiancoin empty mapBlockIndex nubiancoin nubiancoin";
        const char* pszTimestamp = "NubianCoin (NBC) vest Created in fujian  China, For the world 2017-02-18";
        CTransaction txNew;
        txNew.nTime = nChainStartTime;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 4889604799 << CBigNum(9999) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        block.nNonce   = !fTestNet ? 2695180 : 279538;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("0x7fe154c1fc8e24129b9b30231a0d8ed32a7b45b87d2a7406e2911a8394df1c41"));
...
unsigned char pchMessageStart[4] = { 0xe1, 0xef, 0x2e, 0xe3 };
